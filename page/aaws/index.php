            ...
            <div class="col-sm-12">
              ...
              <body>
                ...
                <script>
                  ...
                  ?>
                    var marker = L.marker([<?php echo $data['lat_aaws']; ?>, <?php echo $data['lon_aaws']; ?>], ).bindPopup('<?php echo $data['nama_aaws']; ?>').addTo(map);
                  <?php
                  }
                  ?>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $data['lon_aaws']; ?> / <?php echo $data['lat_aaws']; ?></td>
