      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          <form class="" action="?page=aaws.update" method="post" onsubmit="return validasi(this)">
            ...
            <div class="field item form-group">
              <label class="col-form-label col-md-3 col-sm-3  label-align">Penjaga AAWS<span class="required">*</span></label>
              <div class="col-md-6 col-sm-6">
            ...
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="kontak_aaws" class="form-control" value="<?php echo $data['kontak_aaws']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_aaws']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="date" name="terakhir_kalibrasi_aaws" class="form-control" value="<?php echo $data['terakhir_kalibrasi_aaws']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_aaws']; ?>">
              </div>
            </div>
            <div class="field item form-group">
