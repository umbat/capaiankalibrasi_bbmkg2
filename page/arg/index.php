<div class="right_col" role="main">
  <!-- top tiles -->
  <?php
  $query = mysqli_query($con, "select * from data_arg");
  $no = 0;
  ...
  <div class="row" style="display: inline-block;">
    <div class="tile_count">
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        <span class="count_top"><i class="fa fa-sitemap"></i> Total ARG</span>
        <div class="count">
          <?php
          $data = "data_arg";
          $sql_total = "SELECT id_arg FROM data_arg";
      ...
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        ...
        <div class="count green">
          <?php
          $data_terkalibrasi = "data_arg";
          $sql_terkalibrasi = "SELECT id_arg FROM $data_terkalibrasi where status_arg = 'Terkalibrasi'";
      ...
      <div class="col-md-4 col-sm-4  tile_stats_count">
        ...
        <div class="count red">
          <?php
          $data_belum_terkalibrasi = "data_arg";
          $sql_belum_terkalibrasi = "SELECT id_arg FROM $data_belum_terkalibrasi where status_arg = 'Belum Terkalibrasi'";
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <h2>Monitoring Kalibrasi ARG </h2>

          <ul class="nav navbar-right panel_toolbox">
            <!-- <?php
                  if ($_SESSION['hak_akses'] == 1) {
                  ?>
                          <a class="btn btn-primary btn-sm float-sm-right" href="?page=arg.tambah">+ ARG</a>
                          <br>
                          <?php
                        }
                          ?> -->
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item " href="?page=arg.tambah"><i class="fa fa-plus"></i> Tambah ARG</a>
              </div>
            </li>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="column-title">Nama ARG </th>
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                      $no++;
                      $url_edit = '?page=arg.edit&id=' . $data['id_arg'];
                      $url_hapus = '?page=arg.hapus&id=' . $data['id_arg'];
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $data['nama_arg']; ?></td>
                        <td><?php echo $data['provinsi']; ?></td>
                        <td><?php echo $data['lat_arg']; ?></td>
                        <td><?php echo $data['lon_arg']; ?></td>
                        <td><?php echo $data['nama_penjaga_arg']; ?></td>
                        <td><?php echo $data['kontak_arg']; ?></td>
                        <td><?php echo $data['terakhir_kalibrasi_arg']; ?></td>
                        <td><?php echo $data['petugas_kalibrasi_arg']; ?></td>
                        <td>
                          <?php
                          if ($_SESSION['hak_akses'] == 1) {
                          ?>
