            ...
            <div class="col-sm-12">
              ...
              <body>
                ...
                <script>
                  ...
                  ?>
                    var marker = L.marker([<?php echo $data['lat_arg']; ?>, <?php echo $data['lon_arg']; ?>], ).bindPopup('<?php echo $data['nama_arg']; ?>').addTo(map);
                  <?php
                  }
                  ?>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $data['lon_arg']; ?> / <?php echo $data['lat_arg']; ?></td>
