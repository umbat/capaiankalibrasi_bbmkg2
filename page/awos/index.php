<div class="right_col" role="main">
  <!-- top tiles -->
  <?php
  $query = mysqli_query($con, "select * from data_awos");
  $no = 0;
  ?>
          ...
          <ul class="nav navbar-right panel_toolbox">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <!-- <a class="dropdown-item " href="?page=awos.tambah"><i class="fa fa-plus"></i> Tambah awos</a> -->
              </div>
            </li>
            ...
            <div class="col-sm-12">
              ...
              <body>
                ...
                <script>
                  ...
                  ?>
                    var marker = L.marker([<?php echo $data['lat_awos']; ?>, <?php echo $data['lon_awos']; ?>], ).bindPopup('<?php echo $data['nama_awos']; ?>').addTo(map);
                  <?php
                  }
                  ?>
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <h2>Monitoring Kalibrasi AWOS </h2>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="column-title">Nama awos </th>
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                      $no++;
                      $url_edit = '?page=awos.edit&id=' . $data['id_awos'];
                      $url_hapus = '?page=awos.hapus&id=' . $data['id_awos'];
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
                        <td><?php echo $data['nama_awos']; ?></td>
                        <td><?php echo $data['provinsi']; ?></td>
                        <td><?php echo $data['lon_awos']; ?> / <?php echo $data['lat_awos']; ?></td>
                        <td><?php echo $data['terakhir_kalibrasi_awos']; ?></td>
