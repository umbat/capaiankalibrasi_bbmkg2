<div class="right_col" role="main">
  <!-- top tiles -->
  <?php
  $query = mysqli_query($con, "select * from data_stasiun");
  $no = 0;
    ...
    <div class="tile_count">
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        ...
        <div class="count">
          <?php
          $data = "data_stasiun";
          $sql_total = "SELECT id_stasiun FROM data_stasiun";
      ...
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        ...
        <div class="count green">
          <?php
          $data_terkalibrasi = "data_stasiun";
          $sql_terkalibrasi = "SELECT id_stasiun FROM $data_terkalibrasi where status_stasiun = 'Terkalibrasi'";
      ...
      <div class="col-md-4 col-sm-4  tile_stats_count">
        ...
        <div class="count red">
          <?php
          $data_belum_terkalibrasi = "data_stasiun";
          $sql_belum_terkalibrasi = "SELECT id_stasiun FROM $data_belum_terkalibrasi where status_stasiun = 'Belum Terkalibrasi'";
          ...
          <ul class="nav navbar-right panel_toolbox">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item " href="?page=stasiun.tambah"><i class="fa fa-plus"></i> Tambah AAWS</a>
              </div>
            </li>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="column-title">Nama Stasiun </th>
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                      $no++;
                      $url_edit = '?page=stasiun.edit&id=' . $data['id_stasiun'];
                      $url_hapus = '?page=stasiun.hapus&id=' . $data['id_stasiun'];
                    ?>
                      <tr>
                        <td><?php echo $no; ?></td>
