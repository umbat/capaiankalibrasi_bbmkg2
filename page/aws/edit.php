      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          <form class="" action="?page=aws.update" method="post" onsubmit="return validasi(this)">
            ...
            <div class="field item form-group">
              <label class="col-form-label col-md-3 col-sm-3  label-align">Penjaga AWS<span class="required">*</span></label>
              <div class="col-md-6 col-sm-6">
            ...
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="kontak_aws" class="form-control" value="<?php echo $data['kontak_aws']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_aws']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="date" name="terakhir_kalibrasi_aws" class="form-control" value="<?php echo $data['terakhir_kalibrasi_aws']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_aws']; ?>">
              </div>
            </div>
            <div class="field item form-group">
