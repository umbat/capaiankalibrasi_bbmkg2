            ...
            <div class="col-sm-12">
              ...
              <body>
                ...
                <script>
                  ...
                  ?>
                    var marker = L.marker([<?php echo $data['lat_aws']; ?>, <?php echo $data['lon_aws']; ?>], ).bindPopup('<?php echo $data['nama_aws']; ?>').addTo(map);
                  <?php
                  }
                  ?>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $data['lon_aws']; ?> / <?php echo $data['lat_aws']; ?></td>
                        <td><?php echo $data['terakhir_kalibrasi_aws']; ?></td>
