        ...
        <div class="x_content">
          <form class="" action="?page=aws.update" method="post" onsubmit="return validasi(this)">
            ...
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <select type="text" name="status_aws" class="form-control">
                  ...
                  <option value="Terkalibrasi" <?php if ($data['status_aws'] == 'Terkalibrasi') {
                                                  echo 'selected';
                                                } ?>>Terkalibrasi </option>
                  <option value="Belum Terkalibrasi" <?php if ($data['status_aws'] == 'Belum Terkalibrasi') {
                                                        echo 'selected';
            ...
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="petugas_kalibrasi_aws" class="form-control" value="<?php echo $data['petugas_kalibrasi_aws']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_aws']; ?>">
              </div>
            </div>
            <div class="field item form-group">
