<?php
$id = $_GET['id'];
$sql = "select * from data_inatews where id_inatews='$id'";
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        ...
        <div class="x_content">
          <form class="" action="?page=inatews.update" method="post" onsubmit="return validasi(this)">
            <div class="field item form-group">
              <label class="col-form-label col-md-3 col-sm-3  label-align">Nama Ina-TEWS<span class="required">*</span></label>
              <div class="col-md-6 col-sm-6">
                <input type="text" name="nama_inatews" class="form-control" value="<?php echo $data['nama_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
            ...
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="lat_inatews" class="form-control" value="<?php echo $data['lat_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="lon_inatews" class="form-control" value="<?php echo $data['lon_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              <label class="col-form-label col-md-3 col-sm-3  label-align">Penjaga Ina-TEWS<span class="required">*</span></label>
              <div class="col-md-6 col-sm-6">
                <input type="text" name="nama_penjaga_inatews" class="form-control" value="<?php echo $data['nama_penjaga_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="text" name="kontak_inatews" class="form-control" value="<?php echo $data['kontak_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
              ...
              <div class="col-md-6 col-sm-6">
                <input type="date" name="terakhir_kalibrasi_inatews" class="form-control" value="<?php echo $data['terakhir_kalibrasi_inatews']; ?>">
                <input type="hidden" name="id" class="form-control" value="<?php echo $data['id_inatews']; ?>">
              </div>
            </div>
            <div class="field item form-group">
