    ...
    <div class="tile_count">
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        ...
        <div class="count">
          <?php
          $data = "data_inatews";
          $sql_total = "SELECT id_inatews FROM data_inatews";
      ...
      <div class="col-md-3.5 col-sm-4  tile_stats_count">
        ...
        <div class="count green">
          <?php
          $data_terkalibrasi = "data_inatews";
          $sql_terkalibrasi = "SELECT id_inatews FROM $data_terkalibrasi where status_inatews = 'Terkalibrasi'";
      ...
      <div class="col-md-4 col-sm-4  tile_stats_count">
        ...
        <div class="count red">
          <?php
          $data_belum_terkalibrasi = "data_inatews";
          $sql_belum_terkalibrasi = "SELECT id_inatews FROM $data_belum_terkalibrasi where status_inatews = 'Belum Terkalibrasi'";
        ...
        <div class="x_title">
          ...
          <ul class="nav navbar-right panel_toolbox">
            <!-- <?php
                  ...
                  ?>
                          <a class="btn btn-primary btn-sm float-sm-right" href="?page=inatews.tambah">+ AWS</a>
                          <br>
                          <?php
                        }
                          ?> -->
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item " href="?page=inatews.tambah"><i class="fa fa-plus"></i> Tambah AAWS</a>
              </div>
            </li>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="column-title">Nama Site </th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $data['lat_inatews']; ?></td>
                        <td><?php echo $data['lon_inatews']; ?></td>
                        <td><?php echo $data['terakhir_kalibrasi_inatews']; ?></td>
                        <td><?php echo $data['petugas_kalibrasi_inatews']; ?></td>
                        <td>
                          <?php
                          if ($_SESSION['hak_akses'] == 1) {
                          ?>
